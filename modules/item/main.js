...
require.config({
    ...
    paths: {
        'localstorage': ['https://cdn.rawgit.com/jeromegn/Backbone.localStorage/master/backbone.localStorage-min','https://rawgit.com/jeromegn/Backbone.localStorage/master/backbone.localStorage-min'],
        'jquery.ui': 'https://yastatic.net/jquery-ui/1.11.2/jquery-ui.min',
        'jquery.validate': ['https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.15.0/jquery.validate.min','http://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/jquery.validate.min'],
